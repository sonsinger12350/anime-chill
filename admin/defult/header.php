<div class="page-header">
    <div class="header-wrapper row m-0">
        <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="<?= URL ?>/admin/assets/images/logo/logo.png" alt=""></a></div>
        ...
        <div class="left-side-header col ps-0 d-none d-md-block">
            <div class="input-group"><span class="input-group-text" id="basic-addon1">
                ...
                <input class="form-control" type="text" placeholder="Tìm Kiếm Phim Và Enter...." onkeyup="SearhMovieLive(this)" aria-label="search" aria-describedby="basic-addon1">
            </div>
        </div>
            ...
            <ul class="nav-menus">
                ...
                <li class="d-md-none resp-serch-input">
                    ...
                    <div class="form-group search-form">
                        <input type="text" name="movie-keyword" placeholder="Tìm Kiếm Phim...." onkeyup="SearhMovieLive(this)">
                    </div>
                </li>
                ...
                <li class="profile-nav onhover-dropdown pe-0 py-0 me-0">
                    ...
                    <ul class="profile-dropdown onhover-show-div">
                        <li><a href="<?= URL ?>/admin_movie/change-password"><i data-feather="user"></i><span>Đổi Mật Khẩu</span></a></li>
                        <li><a href="javascript:DangXuatTaiKhoan();"><i data-feather="log-in"> </i><span>Đăng Xuất</span></a></li>
                    </ul>
                </li>
            </ul>
        </div>
        ...
        <!-- <div class="ProfileCard u-cf">
            <div class="ProfileCard-avatar"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-airplay m-0">
