<div class="modal fade bd-example-modal-xl" id="SearchMovieModel" tabindex="-1" role="dialog" aria-hidden="true">
...
<script src="<?= URL ?>/admin/assets/js/photoswipe/photoswipe.min.js"></script>
<script src="<?= URL ?>/admin/assets/js/photoswipe/photoswipe-ui-default.min.js"></script>
<script src="<?= URL ?>/admin/assets/js/photoswipe/photoswipe.js"></script>
