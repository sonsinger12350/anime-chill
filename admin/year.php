...
<head>
    <?php
    $title_admin = "Quản Lý Năm Sản Xuất Phim";
                ...
                <div class="container-fluid general-widget">
                    <div class="row">
                        ...
                        <div class="card col-lg-12" id="NewItem">
                            <div class="card-header">
                                <h4 class="card-title">Thêm Năm Sản Xuất</h4>
                            </div>
                            <div class="card-body">
                                <form submit-ajax="ngockush" form-action="AddNewDatabase" action="<?= URL ?>/admin/server/api" method="POST" form-check="true">
                                    <input type="text" class="form-control" name="table" value="year" style="display: none;">
                                    <div class="form-group row">
                                        <div class="col-12 mb-3">
                                            <label>Năm Sản Xuất</label>
                                            <input type="text" class="form-control" name="New[year]">
                                        </div>
                        ...
                        <div class="card col-lg-12">
                            <div class="card-header">
                                <h4 class="card-title">Danh Sách Năm</h4>
