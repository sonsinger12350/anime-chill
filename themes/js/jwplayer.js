...
window.jwplayer = function(t) {
    ...
    var r = n(17),
        ...
        G = function(t, e) {
            var n, r;
            if (w && t.bind === w)
                return w.apply(t, c.call(arguments, 1));
            if (!gt(t))
                throw new TypeError;
            ...
            return function() {
                ...
                return r = this,
                    ...
                    s <= 0 ? (clearTimeout(u),
                        ...
                        a = Tt,
                        o = t.apply(r, i),
                        r = i = null) : u || !1 === n.trailing || (u = setTimeout(c, s)),
                    o
            }
        },
        ot = function(t) {
                ...
                o = [{
                    ...
                    value: function(t) {
                        var e = t % 1e3,
                            ...
                            r = t;
                        return e >= 400 && e < 600 && (r = "".concat(n, "400-").concat(n, "599")),
                            "JW Player ".concat(t > 299999 && t < 4e5 ? "Warning" : "Error", " ").concat(t, ". For more information see https://developer.jwplayer.com/jw-player/docs/developer-guide/api/errors-reference#").concat(r)
                    }
                }],
    ...
    function o(t) {
        var e = "";
        return t && (t.textContent ? e = Object(r.h)(t.textContent) : t.text && (e = Object(r.h)(t.text))),
            e
    }
        ...
        if (void 0 !== window.ActiveXObject) {
            try {
                if (t = new window.ActiveXObject("ShockwaveFlash.ShockwaveFlash"))
                    return parseFloat(t.GetVariable("$version").split(" ")[1].replace(/\s*,\s*/, "."))
            } catch (t) {
                return 0
            }
            return t
            ...
            version: {
                get: Object(o.C)(function(t, e) {
                        ...
                        return t.chrome ? n = -1 !== e.indexOf("Chrome") ? e.substring(e.indexOf("Chrome") + 7) : e.substring(e.indexOf("CriOS") + 6) : t.safari ? n = e.substring(e.indexOf("Version") + 8) : t.firefox ? n = e.substring(e.indexOf("Firefox") + 8) : t.edge ? n = e.substring(e.indexOf("Edge") + 5) : t.ie && (-1 !== e.indexOf("rv:") ? n = e.substring(e.indexOf("rv:") + 3) : -1 !== e.indexOf("MSIE") && (n = e.substring(e.indexOf("MSIE") + 5))),
                            n && (-1 !== (o = n.indexOf(";")) && (n = n.substring(0, o)), -1 !== (o = n.indexOf(" ")) && (n = n.substring(0, o)), -1 !== (o = n.indexOf(")")) && (n = n.substring(0, o)),
                                r = parseInt(n, 10),
            ...
            version: {
                get: Object(o.C)(function(t, e) {
                        ...
                        if (t.windows)
                            ...
                            t.android ? n = i(/Android ([._\d]+)/.exec(e), 1) : t.iOS ? n = i(/OS ([._\d]+)/.exec(e), 1) : t.mac && (n = i(/Mac OS X (10[._\d]+)/.exec(e), 1));
                        if (n) {
                            r = parseInt(n, 10);
                            var u = n.split(/[._]/);
                            u && (o = parseInt(u[1], 10))
        ...
        u = function() {
            ...
            return e = t,
                (n = [{
                    ...
                    key: "off",
                    value: function(t, e, n) {
                        if (!this._events || !p(this, "off", t, [e, n]))
                            return this;
                        if (!t && !e && !n)
                    ...
                    value: function(t) {
                        ...
                        if (!p(this, "trigger", t, e))
                            return this;
                        var n = this._events[t],
                            r = this._events.all;
                        return n && h(n, e, this),
                            r && h(r, arguments, this),
                            this
                    }
                }, {
                    key: "triggerSafe",
                    value: function(t) {
                        ...
                        var n = this._events[t],
                            r = this._events.all;
                        return n && h(n, e, this, t),
                            r && h(r, arguments, this, t),
                            this
                    }
                }]) && i(e.prototype, n),
                r && i(e, r),
    ...
    function c(t, e) {
        w(t),
            function(t, e) {
                if (!e)
                    return;
                for (var n = document.createDocumentFragment(), r = s(e).childNodes, i = 0; i < r.length; i++)
                        ...
                        if (Array.isArray(n) && n.length)
                            for (var u = Object(i.c)(Object(r.a)(n[0]), t), a = 0; a < u.length; a++)
                                for (var c = u[a], s = t.getProviders(), l = 0; l < o.a.length; l++) {
                                    var f = o.a[l];
                                    if (s.providerSupports(f, c))
                                        return f.name === e
                                }
                        return !1
                    }(t, "html5");
                if (e && s && f)
                    return p = n.e(6).then(function(t) {
                                n(37);
                                var e = n(21).default;
                                return a.a.controls = n(20).default,
                                    Object(u.a)(n(50).default),
                                    e
                            }
    ...
    function o(t, e) {
        if (Object(r.exists)(e) || (e = document.location.href),
            Object(r.exists)(t)) {
            if (u(t))
                return t;
    ...
    function s(t) {
        ...
        if ("string" == typeof t && t.length < 6) {
            ...
            if ("false" === e)
                return !1;
            if (!Object(i.u)(Number(t)) && !Object(i.u)(parseFloat(t)))
                return Number(t)
        }
        return t
    }
    ...
    function f(t, e) {
        if (t <= 0 && !e || Object(i.u)(parseInt(t)))
            return "00:00";
        var n = t < 0 ? "-" : "";
        t = Math.abs(t);
    ...
    function w(t, e, n) {
        return Object(r.j)({}, function(t) {
            ...
            i && (u.sharing = u.sharing || {},
                O(u.sharing, i, "heading"),
                O(u.sharing, i, "copied"));
            o && O(u, t, "abouttext");
    ...
    function s(t, e, n, r) {
        ...
        if ("object" === u(e)) {
            ...
            Object.prototype.hasOwnProperty.call(e, "content") && c && (c = "".concat(c, ' content: "').concat(e.content, '";')),
    ...
    function l(t, e) {
        if (null != t) {
            ...
            for (var i = 0; i < t.length; i++) {
                ...
                if (null != o)
                    for (n in r)
                        Object.prototype.hasOwnProperty.call(r, n) && (u = f(n),
    ...
    var d = function(t, e) {
        ...
        this.getStatus = function() {
            ...
            this.load = function() {
                var n = u[t];
                return 0 !== r ? n : (n && n.then(d).catch(i),
                    r = 1,
                ...
                return n && "object" === o(n) ? Promise.all(Object.keys(n).filter(function(t) {
                    ...
                    return e.setupPlugin(o).then(function(e) {
                        if (!u.attributes._destroyed)
                            return Object(i.a)(e, a, t)
                    }).catch(function(t) {
                        return e.removePlugin(o),
                            t.code ? t : new r.s(null, Object(i.c)(o), t)
                    })
                })) : Promise.resolve()
            }
        },
    ...
    f.setupPlugin = function(t) {
            ...
            return e ? (e.url !== t && Object(c.a)('JW Plugin "'.concat(Object(i.b)(t), '" already loaded from "').concat(e.url, '". Ignoring "').concat(t, '."')),
                e.promise) : this.addPlugin(t).load()
        },
        f.addPlugin = function(t) {
            var e = Object(i.b)(t),
                n = s[e];
            return n || (n = new a.a(t),
                    s[e] = n),
                n
        },
    ...
    function v(t, e) {
        var n = t.get("plugins");
        return window.jwplayerPluginJsonp = h,
            (t.pluginLoader = t.pluginLoader || new u).load(e, p, n, t).then(function(e) {
    ...
    e.b = function(t) {
        ...
        try {
            ...
            if ("pro" === (e = s[0]) && (e = "premium"),
                Object(i.a)(e)("setup") || (e = "invalid"),
                s.length > 2) {
                n = s[1];
                var l = parseInt(s[2]);
        ...
        this.edition = function() {
            ...
            this.error = function() {
                var r;
                return void 0 === t ? r = 100011 : "invalid" !== e && n ? this.duration() < 0 && (r = a) : r = 100012,
                    r ? new u.s(u.m, r) : null
            }
    }
}, function(t, e, n) {
    "use strict";
    ...
    function m(t, e, n, h) {
        ...
        if ("XMLHttpRequest" in window) {
            if (O = k.xhr = k.xhr || new window.XMLHttpRequest,
            ...
            O.onreadystatechange = function(t) {
                                ...
                                return function(t) {
                                    return function(e) {
                                        ...
                                        if (clearTimeout(t.timeoutId),
                                            ...
                                            if (a && o)
                                                return w(n, a, t);
                                            if (t.useDomParser && n.responseText && !a && (a = Object(i.parseXML)(n.responseText)) && a.firstChild)
                                                return w(n, a, t);
                                            if (t.requireValidXML)
                                                return void j(t, u.o, v)
                                        }
                                        t.oncomplete(n)
                                    }
                                }(t)(e);
                ...
                O.onerror = C,
                "overrideMimeType" in O ? k.mimeType && O.overrideMimeType(k.mimeType) : k.useDomParser = !0;
            try {
                t = t.replace(/#.*$/, ""),
                    O.open("GET", t, !0)
            } catch (t) {
            ...
            try {
                k.withCredentials && "withCredentials" in O && (O.withCredentials = !0),
                    O.send()
            } catch (t) {
                C(t, l)
            }
    ...
    function w(t, e, n) {
        ...
        if (!n.requireValidXML || "parsererror" !== i.nodeName && !i.getElementsByTagName("parsererror").length)
            return t.responseXML || (t = Object(r.j)({}, t, {
                    responseXML: e
                })),
                n.oncomplete(t);
        j(n, u.o, h)
    ...
    e.a = function(t) {
        ...
        e.dvrSeekLimit < 5 && (e.dvrSeekLimit = 5),
            e.sources !== Object(e.sources) || u(e.sources) || (e.sources = [Object(i.a)(e.sources)]),
            u(e.sources) && 0 !== e.sources.length || (t.levels ? e.sources = t.levels : e.sources = [Object(i.a)(t)]);
        ...
        return e.sources = e.sources.filter(function(t) {
            ...
            u(e.tracks) || (e.tracks = []),
            u(e.captions) && (e.tracks = e.tracks.concat(e.captions),
                delete e.captions),
    ...
    function l(t, e, n) {
        return delete Object(r.j)({}, n).playlist,
            t.map(function(t) {
                return d(e, t, n)
            }).filter(function(t) {
                return !!t
    ...
    e.a = function(t) {
        if (t && t.file) {
            ...
            var n = /^[^\/]+\/(?:x-)?([^\/]+)$/;
            if (n.test(e.type) && (e.mimeType = e.type,
                    e.type = e.type.replace(n, "$1")),
            ...
            return function(t, e) {
                ...
                (r = [{
                    ...
                    value: function(t, n, r) {
                        return T(t) && (this.handlers[t] || _[t](this)),
                    ...
                    if (Object(a.n)(e, "jw-tab-focus"), ! function(t) {
                        ...
                        if (!t.directSelect || o === e) {
                            ...
                            if (t.dragged = !1,
                                ...
                                "mousedown" === l ? (F(t, y, "mousemove", c, r),
                                    F(t, y, "mouseup", s)) : "touchstart" === l && (F(t, y, "touchmove", c, r),
                                    F(t, y, "touchcancel", s),
                                    F(t, y, "touchend", s),
                                    n || D(i))
                        }
                        ...
                        ! function(t, e, n) {
                            if (t.enableDoubleTap)
                                if (Object(u.a)() - t.lastClick < C) {
                                    ...
                                    t.lastClick = Object(u.a)()
                        }(t, n, o),
                        o ? L(t, i.n, n) : (L(t, i.sb, n),
                            "touchend" !== n.type || w || D(n))
                    }
                };
            b ? F(t, "init", "pointerdown", o, r) : (m && F(t, "init", "mousedown", o, r),
                    F(t, "init", "touchstart", o, r)),
                v || (v = new x(document).on("interaction")),
    ...
    var _ = {
        ...
        interaction: function(t) {
            ...
            F(t, "interaction", "mousedown", e, !0),
                F(t, "interaction", j, e, !0)
        }
    };
    ...
    t.exports = {
        ...
        clear: function(t, e) {
            ...
            if (e) {
                var r = n[e];
                if (r)
                    for (var o = 0; o < r.parts.length; o += 1)
                        r.parts[o]();
                return
            }
    ...
    Object(r.j)(s, {
            ...
            hlsjs: function() {
                return n.e(13).then(function(t) {
                        var e = n(148).default;
                        return e.setEdition && e.setEdition(l),
                            Object(o.a)(e),
                            e
                    }
            ...
            for (var s = 0; s < Object(r.c)(e); s++) {
                ...
                if ("media" === l.prefix) {
                    ...
                    switch (Object(r.b)(l).toLowerCase()) {
                        case "content":
                            if (Object(i.i)(l, "duration") && (n.duration = Object(i.f)(Object(i.i)(l, "duration"))),
                                Object(i.i)(l, "url")) {
                                n.sources || (n.sources = []);
                                var f = {
                        ...
                        case "subtitle":
                            var p = {};
                            p.file = Object(i.i)(l, "url"),
                                p.kind = "captions",
                                Object(i.i)(l, "lang").length > 0 && (p.label = (u = Object(i.i)(l, "lang"),
                                    a = void 0,
                                    (a = {
                                        zh: "Chinese",
                                        nl: "Dutch",
        ...
        c = function(t, e) {
            ...
            if (o.length) {
                ...
                for (var f = 0; f < o.length; f++)
                    o[f].file.length > 0 && (o[f][n] = "true" === o[f][n],
                        o[f].label.length || delete o[f].label,
                        e.sources.push(o[f]))
            }
            if (u.length) {
                e.tracks = [];
                for (var d = 0; d < u.length; d++)
                    u[d].file.length > 0 && (u[d][n] = "true" === u[d][n],
                        u[d].kind = u[d].kind.length ? u[d].kind : "captions",
                        u[d].label.length || delete u[d].label,
                        e.tracks.push(u[d]))
            }
            return e
        },
        ...
        Object(r.j)(d.prototype, {
            ...
            getNewInstance: function(t, e, n) {
                ...
                if ("function" != typeof r)
                    throw new a.s(null, Object(c.c)(this.url) + 100);
                var i = new r(t, e, n);
    ...
    function o(t, e) {
        if (t = String(t),
            ...
            0 === t.length)
            return "";
        for (var n, o, u, a = i(Object(r.a)(t)), c = i((n = e,
                unescape(encodeURIComponent(n))).slice(0, 16)), s = a.length, l = a[s - 1], f = a[0], d = 2654435769 * Math.floor(6 + 52 / s); d;) {
            u = d >>> 2 & 3;
            for (var p = s - 1; p >= 0; p--)
                o = ((l = a[p > 0 ? p - 1 : s - 1]) >>> 5 ^ f << 2) + (f >>> 3 ^ l << 4) ^ (d ^ f) + (c[3 & p ^ u] ^ l),
                f = a[p] -= o;
            d -= 2654435769
        }
        return function(t) {
    ...
    var s = function(t) {
        function e() {
            ...
            return function(t, e) {
                ...
                (t = u(this, a(e).call(this))).attributes = Object.create(null),
                t
        }
        var n, i, s;
        return function(t, e) {
        ...
        function e(e) {
            try {
                ...
                if (c) {
                    ...
                    ;
                    if ("xml" === Object(o.b)(l) && (l = l.nextSibling),
                        "rss" === Object(o.b)(l)) {
                        var d = Object(u.a)(l);
                        a = Object(r.j)({
                            playlist: d
    ...
    var d = function(t, e) {
            ...
            "." === h.base && (h.base = Object(o.getScriptPath)("jwplayer.js")),
                h.base = (h.base || Object(o.loadFrom)()).replace(/\/?$/, "/"),
                n.p = h.base,
                h.width = f(h.width),
                h.height = f(h.height),
                h.aspectratio = function(t, e) {
                ...
                }(h.aspectratio, h.width),
                h.volume = Object(r.z)(h.volume) ? Math.min(Math.max(0, h.volume), 100) : l.volume,
                h.mute = !!h.mute,
                h.language = d,
                h.intl = p;
            var v = i.autoPause;
            ...
            (!h.playbackRateControls || h.playbackRates.indexOf(h.defaultPlaybackRate) < 0) && (h.defaultPlaybackRate = 1),
            h.playbackRate = h.defaultPlaybackRate,
                h.aspectratio || delete h.aspectratio;
            var m = h.playlist;
            if (m)
                Array.isArray(m.playlist) && (h.feedData = m,
                    h.playlist = m.playlist);
            else {
                var y = Object(r.D)(h, ["title", "description", "type", "mediaid", "image", "file", "sources", "tracks", "preload", "duration"]);
                h.playlist = [y]
            }
            h.qualityLabels = h.qualityLabels || h.hlslabels,
                delete h.duration;
            var j = h.liveTimeout;
            null !== j && (Object(r.z)(j) ? 0 !== j && (j = Math.max(30, j)) : j = null,
                h.liveTimeout = j);
            var w, O, k = parseFloat(h.bandwidthEstimate),
                C = parseFloat(h.bitrateSelection);
            return h.bandwidthEstimate = Object(r.z)(k) ? k : (w = h.defaultBandwidthEstimate,
                    O = parseFloat(w),
                    Object(r.z)(O) ? Math.max(O, 1) : l.bandwidthEstimate),
                h.bitrateSelection = Object(r.z)(C) ? C : l.bitrateSelection,
                h.backgroundLoading = Object(r.r)(h.backgroundLoading) ? h.backgroundLoading : a.Features.backgroundLoading,
                h
        },
        p = n(26),
        h = n(7),
    ...
    function j(t) {
        var e = "file:" === window.location.protocol ? "https:" : "",
            n = {
                jwpsrv: "//ssl.p.jwpcdn.com/player/v/8.8.2/jwpsrv.js",
                dai: "//ssl.p.jwpcdn.com/player/plugins/dai/v/0.4.9/dai.js",
                vast: "//ssl.p.jwpcdn.com/player/plugins/vast/v/8.5.11/vast.js",
                googima: "//ssl.p.jwpcdn.com/player/plugins/googima/v/8.5.16/googima.js",
    ...
    var O = function(t, e) {
            ...
            if (u.flashplayer = function(t) {
                    var e = t.flashplayer;
                    return e || (e = (Object(o.getScriptPath)("jwplayer.js") || t.base) + "jwplayer.flash.swf"),
                        "http:" === window.location.protocol && (e = e.replace(/^https/, "http")),
                        e
                }(u),
                u.plugins = function(t) {
                    ...
                    return w(e, t.ga, "gapro"),
                        e
                }(u),
                u.ab && (u.ab = function(t) {
                    var e = t.ab;
                ...
                i = u.playlist,
                Object(r.x)(i) && i.indexOf(g) > -1 && (u.playlist = function(t, e) {
                    ...
                    u.contextual = !0),
                Object(h.isFileProtocol)()) {
                var f = u.playlist,
                    O = u.related;
                m(f) && (u.playlist = y(f)),
                    O && m(O.file) && (O.file = y(O.file))
            }
            return u
        },
        k = n(10),
    ...
    function R(t) {
        return z(t) ? Promise.resolve() : _(t).then(function() {
            if (t.get("drm") || Object(N.b)(t.get("playlist")))
                return Object(N.d)(t.get("edition"))
        }).then(function() {
    ...
    function B(t) {
        ...
        if (n && n.code === p.a) {
            ...
            if (i > 0 && i < 4 && r && o.duration() > -7776e6)
                return new T.a("//content.jwplatform.com/libraries/".concat(r, ".js")).load().then(function() {
    ...
    var q = function(t) {
            ...
            if ("string" == typeof e && ! function(t) {
                ...
                return new T.a(e, !0).load().catch(function(t) {
                    return t
                });
            return Promise.resolve()
        },
        V = function(t) {
            ...
            return !Object(s.h)(n) || Object(s.f)(u) ? Promise.resolve() : new Promise(function(i) {
                return Object(s.i)(r, n).then(function(n) {
                    ...
                    if (!F(t)) {
                        if (!r)
                            throw new E.s(null, E.g);
                        e.localization = Object(s.a)(r, u),
                            i()
                    }
                }).catch(function(t) {
    ...
    Object(r.j)(Y.prototype, {
        getAllItems: function() {
            ...
            return this.items.reduce(function(e, n) {
                ...
                return r && (e[n] = Object(u.serialize)(r)),
                    e
            }, {})
        },
        track: function(t) {
    ...
    var ot = function(t) {
        this._events = {},
            this.modelShim = new K.a,
            this.modelShim._qoeItem = new W.a,
            this.mediaShim = {},
            this.setup = new Q(this.modelShim),
            this.currentContainer = this.originalContainer = t,
            this.apiQueue = new i.a(this, ["load", "play", "pause", "seek", "stop", "playlistItem", "playlistNext", "playlistPrev", "next", "preload", "setConfig", "setCurrentAudioTrack", "setCurrentCaptions", "setCurrentQuality", "setFullscreen", "addButton", "removeButton", "castToggle", "setMute", "setVolume", "setPlaybackRate", "addCues", "setCues", "setPlaylistItem", "resize", "setCaptions", "setControls"], function() {
                return !0
            })
    };
    ...
    function ut(t, e) {
        e && e.code && (e.sourceError && console.error(e.sourceError),
            console.error(E.s.logMessage(e.code)))
    }
    ...
    Object(r.j)(ot.prototype, {
        ...
        init: function(t, e) {
            ...
            i.attributes = i.attributes || {},
                Object(r.j)(this.mediaShim, $.a);
            var a = t,
                c = O(Object(r.j)({}, t), u);
            c.id = e.id,
                c.setupConfig = a,
                Object(r.j)(i.attributes, c, $.b),
            ...
            return i.on("change:errorEvent", ut),
                this.setup.start(e).then(function(t) {
                    var u = t.core;
                    if (!u)
                        throw Object(E.z)(null, E.w);
                    if (n.setup) {
                        n.on(P.ub, at),
                        ...
                        n.apiQueue.destroy(),
                            Object(r.j)(n, u.prototype),
                            n.setup(a, e, n.originalContainer, n._events, c, s);
                        var l = n._model;
                        return i.off("change:errorEvent", ut),
                            l.on("change:errorEvent", ut),
                            o.track(l),
                    ...
                    n.setup && function(t, e, n) {
                        Promise.resolve().then(function() {
                            ...
                            if (!o) {
                                ...
                                Z.a.cloneIcon && u.querySelector(".jw-icon").appendChild(Z.a.cloneIcon("error")),
                                    ct(t, u)
                            }
                            i.set("errorEvent", r),
                                i.set("state", P.mb),
        ...
        playerDestroy: function() {
            this.apiQueue && this.apiQueue.destroy(),
                ...
                this.currentContainer !== this.originalContainer && ct(this, this.originalContainer),
                this.off(),
    ...
    Object(r.j)(V.prototype, {
            ...
            trigger: function(t, e) {
                return (e = r.f.isObject(e) ? Object(r.j)({}, e) : {}).type = t,
    ...
    var Q = function(t) {
        var e, n;
        if (t ? "string" == typeof t ? (e = X(t)) || (n = document.getElementById(t)) : "number" == typeof t ? e = v.a[t] : t.nodeType && (e = X((n = t).id || n.getAttribute("data-jwplayer-id"))) : e = v.a[0],
            e)
            return e;
        if (n) {
            var r = new V(n);
    ...
    Z.api = j,
        Z._ = r.f,
        Z.version = "8.8.2+commercial_v8-8-2.315.commercial.2c5034e.hlsjs..jwplayer.a810fff.dai.45542e3.freewheel.9422044.googima.fd7c6e3.vast.dbafd7d.analytics.c46577e.gapro.8d11024",
        Z.utils = Object(r.j)(D, {
            key: H.b,
            extend: G,
            scriptloader: Y.a,
            rssparser: {
