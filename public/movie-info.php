...
<head>
    ...
    <meta itemprop="name" content="<?= ("Xem Phim {$Movie['name']} {$Movie['seo_title']} Vietsub + Thuyết Minh Tiếng Việt | HHChina.tv | bilibili.tv | iq.com | Hoạt hình trung quốc | Animehay") ?>" />
